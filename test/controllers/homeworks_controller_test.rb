...
class HomeworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post homeworks_url, params: { homework: { score: @homework.score, title: @homework.title } }
    end
  ...
  test "should update homework" do
    patch homework_url(@homework), params: { homework: { score: @homework.score, title: @homework.title } }
